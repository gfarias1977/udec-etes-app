...
const filterOptionsList = [
  {
    label: <IntlMessages id="items.appModule.filterActive" />,
    value: 'S',
  },
  {
    label: <IntlMessages id="items.appModule.filterInactive" />,
    value: 'N',
  },
];
  ...
  return (
    <React.Fragment>
      <Toolbar
        ...
        {numSelected > 0 ? (
          <Typography className={classes.title} color="inherit" variant="subtitle1" component="div">
            {numSelected}{' '}
            {numSelected > 1 ? (
              <IntlMessages id="items.appModule.selectedItems" />
            ) : (
              <IntlMessages id="items.appModule.selectedItem" />
            )}
          </Typography>
        ) : (
          <Typography className={classes.title} variant="h4" id="tableTitle" component="div">
            {<IntlMessages id="items.appModule.items" />}{' '}
            <Button color="primary" onClick={() => onMajorAdd(true)}>
              {<IntlMessages id="items.appModule.addNewItem" />}
            </Button>
          </Typography>
        )}

        {numSelected > 0 ? (
          <Tooltip title={<IntlMessages id="items.appModule.deleteItem" />}>
          ...
          <React.Fragment>
            ...
            <Tooltip title={<IntlMessages id="items.appModule.filterList" />}>
      ...
      <ConfirmDialog
        ...
        title={<IntlMessages id="items.appModule.confirmDelete" />}
        content={<IntlMessages id="items.appModule.confirmDeleteContent" />}
...
export default React.memo(ItemTableToolbar);
