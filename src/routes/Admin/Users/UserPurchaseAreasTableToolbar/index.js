...
const filterOptionsList = [
  { label: <IntlMessages id="users.appModule.purchaseAreasAssignment.filterActive" />, value: 'S' },
  { label: <IntlMessages id="users.appModule.purchaseAreasAssignment.filterInactive" />, value: 'N' },
];

const UserPurchaseAreasTableToolbar = ({
  //selected,
  //setSelected,
  onUserAdd,
  filterOptions,
    ...
    <React.Fragment>
      ...
      >
        ...
        <Typography className={classes.title} variant="h4" id="tableTitle" component="div">
          {<IntlMessages id="users.userPurchaseAreas.label.purchaseAreas" />}{' '}
          <Button
            color="primary"
...
UserPurchaseAreasTableToolbar.propTypes = {
...
export default React.memo(UserPurchaseAreasTableToolbar);
