...
const filterOptionsList = [
  { label: <IntlMessages id="users.appModule.BusinessUnitsAssignment.filterActive" />, value: 'S' },
  { label: <IntlMessages id="users.appModule.BusinessUnitsAssignment.filterInactive" />, value: 'N' },
];

const UserBusinessUnitsTableToolbar = ({
  //selected,
  //setSelected,
  onUserAdd,
  filterOptions,
    ...
    <React.Fragment>
      ...
      >
        ...
        <Typography className={classes.title} variant="h4" id="tableTitle" component="div">
          {<IntlMessages id="users.userBusinessUnits.label.BusinessUnits" />}{' '}
          <Button
            color="primary"
...
UserBusinessUnitsTableToolbar.propTypes = {
...
export default React.memo(UserBusinessUnitsTableToolbar);
