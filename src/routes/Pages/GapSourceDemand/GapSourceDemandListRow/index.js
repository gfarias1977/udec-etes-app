...
const getGapSourceDemandActions = user => {
  const actions = [
    {
      action: 'view',
...
const GapSourceDemandListRow = ({ row, isSelected, onRowClick, onProcessEdit, onProcessDelete, onProcessView }) => {
  ...
  const procesessActions = getGapSourceDemandActions(row);
...
export default React.memo(GapSourceDemandListRow);
