...
const StandardRoomsLayoutReportTableToolbar = ({
  selected,
  setSelected,
  onUserAdd,
  filterOptions,
    ...
    <React.Fragment>
      <Toolbar
        ...
        <Typography className={classes.title} variant="h4" id="tableTitle" component="div">
          {<IntlMessages id="standardRoomsLayoutReport.appModule.standardRoomsLayoutReport" />}{' '}
        </Typography>
        <React.Fragment>
...
StandardRoomsLayoutReportTableToolbar.propTypes = {
...
export default React.memo(StandardRoomsLayoutReportTableToolbar);
