...
const StandardMajorReportTableToolbar = ({
  selected,
  setSelected,
  onUserAdd,
  filterOptions,
    ...
    <React.Fragment>
      <Toolbar
        ...
        <Typography className={classes.title} variant="h4" id="tableTitle" component="div">
          {<IntlMessages id="standardMajorReport.appModule.standardMajorReport" />}{' '}
        </Typography>
        <React.Fragment>
...
StandardMajorReportTableToolbar.propTypes = {
...
export default React.memo(StandardMajorReportTableToolbar);
