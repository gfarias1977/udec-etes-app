...
const StandardEquipmentByMajorReportTableToolbar = ({
  selected,
  setSelected,
  onUserAdd,
  filterOptions,
    ...
    <React.Fragment>
      <Toolbar
        ...
        <Typography className={classes.title} variant="h4" id="tableTitle" component="div">
          {<IntlMessages id="standardEquipmentByMajorReport.appModule.standardEquipmentByMayorReport" />}{' '}
        </Typography>
        <React.Fragment>
...
StandardEquipmentByMajorReportTableToolbar.propTypes = {
...
export default React.memo(StandardEquipmentByMajorReportTableToolbar);
