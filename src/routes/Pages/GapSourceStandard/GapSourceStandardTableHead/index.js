...
const headCells = [
  ...
  },
  {
    ...
    numeric: false,
    disablePadding: false,
    label: <IntlMessages id="procesess.appModule.procCodeHeader" />,
  },
  {
    id: 'procCreationDate',
    numeric: false,
  ...
  },
  {
    ...
    numeric: false,
    disablePadding: false,
    label: <IntlMessages id="procesess.appModule.procMsgHeader" />,
  },
  {
...
function GapSourceStandardTableHead({ classes, onSelectAllClick, order, orderBy, numSelected, rowCount, onRequestSort }) {
...
GapSourceStandardTableHead.propTypes = {
...
export default React.memo(GapSourceStandardTableHead);
