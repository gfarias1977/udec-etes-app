...
const StandardDetailView = ({ open, onCloseDialog }) => {
  const classes = useStyles();
  const { currentUser: currentStandard } = useSelector(({ standardsReducer }) => standardsReducer);

  const { name, email, status, phones, company, designation, profile_pic, starred } = currentStandard;
