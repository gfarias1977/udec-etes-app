...
const getGapSourceStockActions = user => {
  const actions = [
    {
      action: 'view',
...
const GapSourceStockListRow = ({ row, isSelected, onRowClick, onProcessEdit, onProcessDelete, onProcessView }) => {
  ...
  const procesessActions = getGapSourceStockActions(row);
...
export default React.memo(GapSourceStockListRow);
