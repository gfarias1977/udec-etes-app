...
import GapSourceStockListRow from './GapSourceStockListRow';
import GapSourceStockTableHead from './GapSourceStockTableHead';
import GapSourceStockTableToolbar from './GapSourceStockTableToolbar';
...
import AddEditGapSourceStock from './AddEditGapSourceStock';
import GapSourceStockDetailView from './GapSourceStockDetailView';

const GapSourceStockModule = () => {
  const proctId = process.env.REACT_APP_SOURCE_STOCK;
  ...
  return (
    <div className={classes.root}>
      ...
      {openGapSourceStockDialog && (
        <AddEditGapSourceStock open={openGapSourceStockDialog} onCloseDialog={handleCloseUserDialog} />
      )}
      {openViewDialog && <GapSourceStockDetailView open={openViewDialog} onCloseDialog={handleCloseViewDialog} />}
