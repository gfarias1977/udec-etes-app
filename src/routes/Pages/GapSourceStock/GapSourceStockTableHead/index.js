...
function GapSourceStockTableHead({ classes, onSelectAllClick, order, orderBy, numSelected, rowCount, onRequestSort }) {
...
GapSourceStockTableHead.propTypes = {
...
export default React.memo(GapSourceStockTableHead);
