...
import { bulkLoadStock } from 'redux/actions/GapSourceStock';
...
const AddEditGapSourceStock = ({ open, onCloseDialog }) => {
  ...
  const onSubmitClick = () => {
    ...
    // Valida comentario para notificacion de proceso stock
    if (!msg) {
  ...
  return (
    <Dialog open={open} onClose={onCloseDialog} className={classes.dialogRoot}>
      <DialogTitle className={classes.dialogTitleRoot}>
        <IntlMessages id="procesess.editCreate.form.createTitle" />
      </DialogTitle>
...
export default AddEditGapSourceStock;

AddEditGapSourceStock.prototype = {
