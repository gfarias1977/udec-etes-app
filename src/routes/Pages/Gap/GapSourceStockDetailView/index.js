...
const GapSourceStockDetailViewModule = ({ open, onCloseDialog }) => {
  ...
  const handleOnSubmitClick = event => {
    ...
    if (currentProcess.procStockId === null || currentProcess.procStock === null || purchaseArea === null) {
    ...
    if (checkInputData === true) {
      dispatch(
        getAllGapSourceStock(
          ...
          debouncedSearchTerm,
          purchaseArea,
          currentProcess.procStockId,
          currentProcess.procStock,
          gapstOrgCode,
          gapstCampCode,
          gapstCityCode,
          gapstItemId,
              ...
              <CardHeader
                ...
                title={
                  <IntlMessages
                    ...
                    values={{ code: currentProcess.procStock }}
                  />
                }
              />
              <CardContent>
                  ...
                  <GridContainer spacing={2}>
                    <Grid item xs={12} sm={6}>
                      <TextField
                        ...
                        value={currentProcess.procStock}
                        editable="false"
                      />
                    </Grid>
                    <Grid item xs={12} sm={6}>
