...
//
import { getAllGapPeriodsDda } from 'redux/actions/Gap';
import { getAllGapPurchases } from 'redux/actions/GapPurchases';
...
import ExportButtonGapPurchasesReport from 'components/ExportButtonGapPurchasesReport';

const GapPurchasesDetailViewModule = ({ open, onCloseDialog }) => {
  const classes = useStyles();
  const { gapsPeriodsDda } = useSelector(({ gapsReducer }) => gapsReducer);
  const { gapPurchases } = useSelector(({ gapPurchasesReducer }) => gapPurchasesReducer);
  ...
  const [gapdYear, setGapdYear] = React.useState(null);
  const [gapdPeriod, setGapdPeriod] = React.useState(null);
  ...
  const handleSelectAllClick = event => {
    if (event.target.checked) {
      const newSelected = gapPurchases.map(n => n.procId);
  ...
  const handleOnSubmitClick = event => {
    ...
    if (currentProcess.procId === null || currentProcess.procCode === null || purchaseArea === null) {
      dispatch(fetchError(<IntlMessages id="gapPurchases.gapPurchasesDetailview.appModule.dataRequired" />));
  ...
  return (
    <Dialog maxWidth="xl" open={open} onClose={onCloseDialog} className={classes.dialogRoot} scroll="body">
      <DialogTitle className={classes.dialogTitleRoot}>
        <IntlMessages id="gapPurchases.edit.form.editTitle" />
      </DialogTitle>
          ...
          <Paper className={classes.paper}>
            <Card className={classes.root}>
              <CardHeader
                ...
                title={
                  <IntlMessages
                    id="gapPurchases.gapsDetailview.labelProcCode.title"
                  ...
                  <GridContainer spacing={2}>
                    <Grid item xs={12} sm={6}>
                      <TextField
                        fullWidth
                        variant="outlined"
                        label={<IntlMessages id="gapPurchases.gapsDetailview.label.labelProcCode" />}
                    ...
                    <Grid item xs={12} sm={6}>
                      <Autocomplete
                        ...
                        renderInput={params => (
                          <TextField
                            {...params}
                            label={<IntlMessages id="gapPurchases.filters.label.labelGapstCities" />}
                            variant="outlined"
                    ...
                    {/*                     <Grid item xs={12} sm={6}>
                      <Autocomplete
                        ...
                        renderInput={params => (
                          <TextField
                            {...params}
                            label={<IntlMessages id="gapPurchases.filters.label.labelGapstYearPeriod" />}
                            variant="outlined"
                        ...
                        onChange={(event, value) => {
                          setPeriodText(value);
                          setPeriodError('');
                          setGapdPeriod(value ? value.gaprAcademicPeriod : null);
                          setGapdYear(value ? value.gaprAcademicYear : null);
                        }}
                      />
                    </Grid> */}
                    <Grid item xs={12} sm={6}>
                      <Autocomplete
                        ...
                        renderInput={params => (
                          <TextField
                            {...params}
                            label={<IntlMessages id="gapPurchases.filters.label.labelGapstOrganizations" />}
                            variant="outlined"
                    ...
                    <Grid item xs={12} sm={6}>
                      <Autocomplete
                        ...
                        renderInput={params => (
                          <TextField
                            {...params}
                            label={<IntlMessages id="gapPurchases.filters.label.labelGapstVolume" />}
                            variant="outlined"
                    ...
                    <Grid item xs={12} sm={6}>
                      <Autocomplete
                        ...
                        renderInput={params => (
                          <TextField
                            {...params}
                            label={<IntlMessages id="gapPurchases.filters.label.labelGapstCampus" />}
                            variant="outlined"
                    ...
                    <Grid item xs={12} sm={6}>
                      <Autocomplete
                        ...
                        renderInput={params => (
                          <TextField
                            {...params}
                            label={<IntlMessages id="gapPurchases.filters.label.labelGapstItems" />}
                            variant="outlined"
                    ...
                    <Grid item xs={12} sm={6}>
                      <Autocomplete
                        ...
                        renderInput={params => (
                          <TextField
                            {...params}
                            label={<IntlMessages id="gapPurchases.filters.label.labelGapstSchool" />}
                            variant="outlined"
                    ...
                    <Grid item xs={12} sm={6}>
                      <Autocomplete
                        ...
                        renderInput={params => (
                          <TextField
                            {...params}
                            label={<IntlMessages id="gapPurchases.filters.label.labelGapsCourses" />}
                            variant="outlined"
                    ...
                    <Grid item xs={12} sm={6}>
                      ...
                      <Box display="flex" justifyContent="flex-end" mb={4}>
                        <Box ml={2}>
                          {gapPurchases && gapPurchases.length > 0 && <ExportButtonGapPurchasesReport data={gapPurchases} />}
                        </Box>
                      </Box>
                    </Grid>
                  </GridContainer>
            ...
            <TableContainer className={classes.container}>
              <Table stickyHeader className={classes.table} aria-labelledby="tableTitle" aria-label="sticky enhanced table">
                <GapDetailViewTableHead
                  ...
                  rowCount={gapPurchases.length}
                />
                <TableBody>
                  {!!gapPurchases.length ? (
                    stableSort(gapPurchases, getComparator(order, orderBy))
                    ...
                    <TableRow style={{ height: 53 * 6 }}>
                      <TableCell colSpan={7} rowSpan={10}>
                        {isFilterApplied ? (
                          <NoRecordFound>{<IntlMessages id="gapPurchases.appModule.filterNoRecordsFound" />}</NoRecordFound>
                        ) : (
                          <NoRecordFound>
                            {gapsFetched ? (
                              <IntlMessages id="gapPurchases.appModule.noRecordsFound" />
                            ) : (
                              <IntlMessages id="gapPurchases.appModule.loadingGapPurchases" />
                            )}
                          </NoRecordFound>
                        )}
                      </TableCell>
...
export default GapPurchasesDetailViewModule;

GapPurchasesDetailViewModule.prototype = {
