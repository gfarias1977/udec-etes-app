...
const filterOptionsList = [
  {
    label: <IntlMessages id="gapPurchases.appModule.filterActive" />,
    value: 'P',
  },
  {
    label: <IntlMessages id="gapPurchases.appModule.filterInactive" />,
    value: 'N',
  },
];

const GapDetailViewTableToolbar = ({
  selected,
  setSelected,
  onProcessAdd,
  filterOptions,
  ...
  return (
    <React.Fragment>
      <Toolbar
        ...
        {numSelected > 0 ? (
          <Typography className={classes.title} color="inherit" variant="subtitle1" component="div">
            {numSelected}{' '}
            {numSelected > 1 ? (
              <IntlMessages id="gapPurchases.appModule.selectedPurchases" />
            ) : (
              <IntlMessages id="gapPurchases.appModule.selectedPurchase" />
            )}
          </Typography>
        ) : (
          <Typography className={classes.title} variant="h4" id="tableTitle" component="div">
            {<IntlMessages id="gapPurchases.appModule.processPurchases" />}{' '}
            <Button color="primary" onClick={() => onProcessAdd(true)}>
              {<IntlMessages id="gapPurchases.appModule.addNewGapPurchase" />}
            </Button>
          </Typography>
        )}

        {numSelected > 0 ? (
          <Tooltip title={<IntlMessages id="gapPurchases.appModule.deleteGapPurchase" />}>
          ...
          <React.Fragment>
            ...
            <Tooltip title={<IntlMessages id="gapPurchases.appModule.filterList" />}>
      ...
      <ConfirmDialog
        ...
        title={<IntlMessages id="gapPurchases.appModule.confirmDelete" />}
        content={<IntlMessages id="gapPurchases.appModule.confirmDeleteContent" />}
...
GapDetailViewTableToolbar.propTypes = {
...
export default React.memo(GapDetailViewTableToolbar);
