...
const GapSourceDemandTableToolbar = ({
  selected,
  setSelected,
  onProcessAdd,
  filterOptions,
      ...
      <Toolbar
        ...
        {numSelected > 0 ? (
          ...
          <Typography className={classes.title} variant="h4" id="tableTitle" component="div">
            {<IntlMessages id="procesess.appModule.processDemand" />}{' '}
            <Button color="primary" onClick={() => onProcessAdd(true)}>
              {<IntlMessages id="procesess.appModule.addNewProcessDemand" />}
            </Button>
          </Typography>
        )}
...
GapSourceDemandTableToolbar.propTypes = {
...
export default React.memo(GapSourceDemandTableToolbar);
