...
const GapSourceDemandDetailViewModule = ({ open, onCloseDialog }) => {
  ...
  const handleOnSubmitClick = event => {
    ...
    if (currentProcess.procDemandId === null || currentProcess.procDemand === null || purchaseArea === null) {
    ...
    if (checkInputData === true) {
      dispatch(
        getAllGapSourceDemand(
          filterOptions,
          debouncedSearchTerm,
          currentProcess.procDemandId,
          currentProcess.procDemand,
              ...
              <CardHeader
                ...
                title={
                  <IntlMessages
                    ...
                    values={{ code: currentProcess.procDemand }}
                  />
                }
              />
              <CardContent>
                  ...
                  <GridContainer spacing={2}>
                    <Grid item xs={12} sm={6}>
                      <TextField
                        ...
                        value={currentProcess.procDemand}
                        editable="false"
                      />
                    </Grid>
                    <Grid item xs={12} sm={6}>
