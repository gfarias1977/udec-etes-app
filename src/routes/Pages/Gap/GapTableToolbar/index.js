      ...
      <Toolbar
        ...
        {numSelected > 0 ? (
          ...
          <Typography className={classes.title} variant="h4" id="tableTitle" component="div">
            {<IntlMessages id="procesess.appModule.processGap" />}{' '}
            <Button color="primary" onClick={() => onProcessAdd(true)}>
              {<IntlMessages id="procesess.appModule.addNewProcessGap" />}
            </Button>
          </Typography>
        )}
...
export default React.memo(GapTableToolbar);
