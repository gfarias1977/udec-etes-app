...
const filterOptionsList = [
  {
    label: <IntlMessages id="gapsSourceStandard.appModule.filterActive" />,
    value: 'P',
  },
  {
    label: <IntlMessages id="gapsSourceStandard.appModule.filterInactive" />,
    value: 'N',
  },
];
  ...
  return (
    <React.Fragment>
      <Toolbar
        ...
        {numSelected > 0 ? (
          <Typography className={classes.title} color="inherit" variant="subtitle1" component="div">
            {numSelected}{' '}
            {numSelected > 1 ? (
              <IntlMessages id="gapsSourceStandard.appModule.selectedProcesess" />
            ) : (
              <IntlMessages id="gapsSourceStandard.appModule.selectedProcess" />
            )}
          </Typography>
        ) : (
          <Typography className={classes.title} variant="h4" id="tableTitle" component="div">
            {<IntlMessages id="gapsSourceStandard.appModule.procesess" />}{' '}
            <Button color="primary" onClick={() => onProcessAdd(true)}>
              {<IntlMessages id="gapsSourceStandard.appModule.addNewProcessStandard" />}
            </Button>
          </Typography>
        )}

        {numSelected > 0 ? (
          <Tooltip title={<IntlMessages id="gapsSourceStandard.appModule.deleteProcess" />}>
          ...
          <React.Fragment>
            ...
            <Tooltip title={<IntlMessages id="gapsSourceStandard.appModule.filterList" />}>
      ...
      <ConfirmDialog
        ...
        title={<IntlMessages id="gapsSourceStandard.appModule.confirmDelete" />}
        content={<IntlMessages id="gapsSourceStandard.appModule.confirmDeleteContent" />}
